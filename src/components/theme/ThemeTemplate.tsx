...
import FaqList from "@/components/destination/FaqList";
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="absolute inset-0 flex flex-col justify-center">
            <div className="hero-anim max-w-[1200px] mx-auto px-4 sm:px-gutter w-full">
              ...
              <div className="flex flex-col xs:flex-row flex-wrap gap-3 sm:gap-4">
                ...
                <a href="#pourquoi" className="hero-cta-ghost">
        ...
        {/* CARROUSEL DESTINATIONS (cohérentes avec le thème) */}
        <section className="bg-white py-section_padding_v overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-gutter">
            <div className="flex justify-between items-end mb-8 sm:mb-10">
              <div>
                ...
                <h2 className="font-h2 text-[24px] sm:text-[28px] md:text-h2 text-on-surface">
                  Nos destinations idéales pour ce type de séjour
                </h2>
              </div>
              <Link
            ...
            <ThemeDestCarousel cards={content.destinations} />
          </div>
        </section>
          ...
          <section className="bg-white py-section_padding_v">
            <div className="max-w-[1200px] mx-auto px-4 sm:px-gutter">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                {content.atypical.cards.map((card) => (
                  <div className="pack-card" key={card.name}>
        ...
        {/* QUAND PARTIR (calendrier des saisons) */}
        {content.whenToGo && (
          <section className="section-bg-blue py-section_padding_v">
            <div className="max-w-[1200px] mx-auto px-4 sm:px-gutter">
              <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12">
                <p className="text-primary font-label text-label mb-3 tracking-wider uppercase text-[12px] sm:text-[14px]">
                  {content.whenToGo.eyebrow}
                </p>
                <h2 className="font-h2 text-[26px] sm:text-[32px] md:text-h2 text-on-surface mb-4">
                  {content.whenToGo.h2}
                </h2>
                {content.whenToGo.intro && (
                  <p className="font-body-lg text-[15px] sm:text-body-lg text-on-surface-variant leading-relaxed">
                    {content.whenToGo.intro}
                  </p>
                )}
                ...
                <div className="min-w-[680px]">
                  ...
                  >
                    ...
                    {MONTHS.map((m, i) => (
                      <div
                        key={i}
                        className="text-center text-[12px] font-semibold text-on-surface-variant"
                      >
                        {m}
                      </div>
                    ))}
                  ...
                  {/* Lignes destinations */}
                  {content.whenToGo.rows.map((row) => (
                    <div
                      key={row.destination}
                      className="grid items-center"
                      style={{ gridTemplateColumns: "150px repeat(12, 1fr)" }}
                    >
                      <div className="text-[13px] sm:text-[14px] font-semibold text-on-surface pr-3 py-1.5">
                        {row.destination}
                      </div>
                      {row.months.map((m, i) => (
                        <div key={i} className="px-[3px] py-1.5">
                          <div
                ...
                {(["ideal", "ok", "avoid"] as const).map((k) => (
                  ...
                  >
                    <span
                      ...
                      style={{ backgroundColor: CAL_COLORS[k] }}
                    />
                    {CAL_LABELS[k]}
                  </span>
                ))}
        ...
        {/* POURQUOI CE TYPE DE SÉJOUR */}
        <section className="bg-white py-section_padding_v" id="pourquoi">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-gutter">
