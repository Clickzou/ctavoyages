...
// Destinations voyage (catalogue CTA Voyages) + destinations sportives.
const ALL_DEST_GROUPS: DestGroup[] = [
  {
    label: "Asie",
    options: [
      { text: "Bali", value: "Bali", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Cambodge", value: "Cambodge", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Chine", value: "Chine", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Corée du Sud", value: "Corée du Sud", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Inde", value: "Inde", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Indonésie", value: "Indonésie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Japon", value: "Japon", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Laos", value: "Laos", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Malaisie", value: "Malaisie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Philippines", value: "Philippines", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Sri Lanka", value: "Sri Lanka", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Thaïlande", value: "Thaïlande", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Vietnam", value: "Vietnam", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
    ],
  },
  {
    label: "Afrique et Océan Indien",
    options: [
      { text: "Afrique du Sud", value: "Afrique du Sud", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Botswana", value: "Botswana", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Cap-Vert", value: "Cap-Vert", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Égypte", value: "Égypte", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Île Maurice", value: "Île Maurice", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Kenya", value: "Kenya", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "La Réunion", value: "La Réunion", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Maldives", value: "Maldives", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Maroc", value: "Maroc", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Namibie", value: "Namibie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Sénégal", value: "Sénégal", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Seychelles", value: "Seychelles", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Tanzanie", value: "Tanzanie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Tunisie", value: "Tunisie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
  ...
  },
  {
    label: "Amériques",
    options: [
      { text: "Antilles françaises", value: "Antilles françaises", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Argentine", value: "Argentine", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Bahamas", value: "Bahamas", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Bolivie", value: "Bolivie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Brésil", value: "Brésil", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Canada", value: "Canada", types: "sejour,circuit,croisiere,glamping,sur-mesure,sportif", sports: "Formule 1" },
      { text: "Chili", value: "Chili", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Costa Rica", value: "Costa Rica", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Guatemala", value: "Guatemala", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Jamaïque", value: "Jamaïque", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Mexique", value: "Mexique", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Patagonie", value: "Patagonie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Pérou", value: "Pérou", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "République dominicaine", value: "République dominicaine", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
    ],
  },
  {
    label: "Europe",
    options: [
      { text: "Açores", value: "Açores", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Amsterdam", value: "Amsterdam", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Autriche", value: "Autriche", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Crète", value: "Crète", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Croatie", value: "Croatie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Danemark", value: "Danemark", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Écosse", value: "Écosse", types: "sejour,circuit,croisiere,glamping,sur-mesure,sportif", sports: "Rugby" },
      { text: "Espagne", value: "Espagne", types: "sejour,circuit,croisiere,glamping,sur-mesure,sportif", sports: "Football,NFL,Formule 1,Moto GP" },
      { text: "Finlande", value: "Finlande", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "France", value: "France", types: "sejour,circuit,croisiere,glamping,sur-mesure,sportif", sports: "Rugby" },
      { text: "Grèce", value: "Grèce", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Islande", value: "Islande", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Italie", value: "Italie", types: "sejour,circuit,croisiere,glamping,sur-mesure,sportif", sports: "Football,Rugby,Formule 1,Moto GP" },
      ...
      { text: "Norvège", value: "Norvège", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Pays-Bas", value: "Pays-Bas", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Porto", value: "Porto", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Portugal", value: "Portugal", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Rome", value: "Rome", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Royaume-Uni", value: "Royaume-Uni", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Santorin", value: "Santorin", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Slovénie", value: "Slovénie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Suède", value: "Suède", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Suisse", value: "Suisse", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Venise", value: "Venise", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
    ],
  },
  {
    label: "Océanie",
    options: [
      { text: "Australie", value: "Australie", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Nouvelle-Zélande", value: "Nouvelle-Zélande", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
      { text: "Polynésie française", value: "Polynésie française", types: "sejour,circuit,croisiere,glamping,sur-mesure", sports: "" },
    ],
  },
  {
    label: "Europe",
