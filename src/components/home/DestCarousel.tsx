...
const DESTS: Dest[] = [
  ...
  {
    href: "/destination/royaume-uni",
    img: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&h=400&fit=crop&auto=format",
    alt: "Voyage au Royaume-Uni",
    badge: "EUROPE",
    name: "Royaume-Uni",
    desc: "Londres, Highlands écossais, châteaux et villages des Cotswolds.",
  },
  {
    href: "/destination/pays-bas",
    img: "https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=600&h=400&fit=crop&auto=format",
    alt: "Voyage aux Pays-Bas",
    badge: "EUROPE",
    name: "Pays-Bas",
    desc: "Canaux d'Amsterdam, champs de tulipes, moulins et vélos à l'infini.",
  },
  {
