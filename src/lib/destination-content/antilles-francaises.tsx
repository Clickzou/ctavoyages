...
const antillesFrancaises: DestinationContent = {
  ...
  meta: {
    title:
      "Voyage aux Antilles : Guadeloupe & Martinique",
    description:
      "Voyage en Guadeloupe et Martinique avec CTA Voyages. Plages des Salines, Soufrière et chutes du Carbet, Les Saintes, réserve Cousteau.",
  },
  hero: {
